...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware([
        ...
        Route::post(
            '/storefront/carts/{cartPublicId}/checkout/payment-attempts',
            [StorefrontCartController::class, 'createPaymentAttempt'],
        );

        Route::post(
            '/storefront/carts/{cartPublicId}/checkout/payment-attempts/{attemptPublicId}/sandbox/settle',
            [StorefrontCartController::class, 'settleSandboxPayment'],
        );
