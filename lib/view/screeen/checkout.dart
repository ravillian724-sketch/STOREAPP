        ...
        bottomNavigationBar: Container(
          ...
          child: MaterialButton(
            ...
            onPressed: () {
              ...
              appDebugLog("🧠 Chronic Diseases: $diseases");
              appDebugLog("💊 Other Medications: $medications");
              appDebugLog("📋 Doctor Notes: $notes");
                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    InkWell(
                      ...
                      child: CardDeliveryTypeCheckout(
                        imagename: AppImageAsset.local2,
                        title: "104".tr, //Local
                    ...
                    Column(
                      ...
                      children: [
                        if (controller.dataaddress.isNotEmpty)
                          Text(
                            "105".tr, //Choose Shipping Address
                            style: const TextStyle(
                                color: AppColor.secondColor,
                                fontWeight: FontWeight.bold,
                                fontSize: 18),
