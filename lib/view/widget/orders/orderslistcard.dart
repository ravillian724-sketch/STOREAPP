  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      margin: EdgeInsets.symmetric(
          horizontal: Responsive.margin(20), vertical: Responsive.margin(16)),
      child: Container(
              ...
              children: [
                Container(
                  padding: EdgeInsets.symmetric(
                      horizontal: Responsive.padding(18),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  if (listdata.ordersType != "1") const Divider(height: 16),
              ...
              children: [
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    shape: RoundedRectangleBorder(
                      borderRadius:
                          BorderRadius.circular(Responsive.radius(15)),
                    ),
                  ),
