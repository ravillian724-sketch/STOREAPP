class CartModel {
  ...
  CartModel.fromJson(Map<String, dynamic> json) {
    // تحويل itemsprice إلى double
    itemsprice = (json['itemsprice'] is int) 
        ? (json['itemsprice'] as int).toDouble()
        : double.tryParse(json['itemsprice'].toString());
